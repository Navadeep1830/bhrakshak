...
class Settings(BaseSettings):
    ...
    redis_url: str = "redis://localhost:6600/0" # host port mapped in docker-compose (6380 collides with Hyper-V reservations on some Windows hosts)
    ...
    cors_origins: str = "http://localhost:3000,http://localhost:5173,https://bhrakshak-dashboard-demo.loca.lt"
