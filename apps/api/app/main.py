...
from app.api.v1 import alerts, analytics, auth, ble, briefing, demo, evacuation, incident_command, ingest, logistics, mesh, reports, roads, ws, zones
...
for r in (auth.router, zones.router, reports.router, alerts.router, roads.router,
          ...
          incident_command.router, evacuation.router, ble.router, mesh.router):
