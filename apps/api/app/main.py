...
from app.api.v1 import alerts, analytics, auth, ble, briefing, chat, demo, events, evacuation, geo, incident_command, ingest, logistics, mesh, public, reports, roads, ws, zones
...
for r in (auth.router, zones.router, reports.router, alerts.router, roads.router,
          ...
          chat.router, geo.router, events.router):
